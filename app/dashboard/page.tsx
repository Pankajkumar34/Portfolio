...
// import HeroSec from '@/components/dashboardComponents/heroSec';
...
//             <HeroSec handleSave={handleSave} sections={sections} updateSection={updateSection} saving={saving} />
//           )}

//           {/* Profile Section Editor */}
//           {activeTab === 'profile' && sections.profile && (
//           <ProfileSec  handleSave={handleSave} sections={sections} updateSection={updateSection} saving={saving}/>
//           )}

//           {/* Experience Section Editor */}
//           {activeTab === 'experience' && sections.experience && (
//             <ExprienceSec  handleSave={handleSave} sections={sections} updateSection={updateSection} saving={saving}/>
//           )}

//           {/* Skills Section Editor */}
//           {activeTab === 'skills' && sections.skills && (
//             <SkillsSec  handleSave={handleSave} sections={sections} updateSection={updateSection} saving={saving}/>
//           )}

//           {/* Companies Section Editor */}
//           {activeTab === 'companies' && sections.companies && (
//          <LastCompnieseSec  handleSave={handleSave} sections={sections} updateSection={updateSection} saving={saving}/>
//           )}
  ...
  const handleSave = async (sectionName: string) => {
    ...
    try {
      const res = await fetch('/api/section', {
        ...
        body: JSON.stringify({
          sectionName,
          content: sections[sectionName as keyof typeof sections],
        }),
        credentials: 'include',
      });
